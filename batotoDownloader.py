...
class MangaDownloader(QtCore.QObject):
    ...
    def getHtml(self, url):
        ...
        req = urllib.request.urlopen(urllib.request.Request(url, headers={"User-Agent": "Mozilla/5.0 (X11; U; Linux i686) Gecko/20071127 Firefox/2.0.0.11", "Accept-Encoding": "gzip", "Referer": "http://bato.to/reader"}))
    ...
    def downloadChapter(self, chaptersListUrl, downloadDir, saveToZip):
        ...
        chaptersListUrl = "http://bato.to/areader?id=" + chaptersListUrl[chaptersListUrl.find("#")+1:] + "&p="
        
        chaptersListHtml = self.getHtml(chaptersListUrl + "1")
